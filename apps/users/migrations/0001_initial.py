    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula', models.CharField(help_text='Ejemplo: V011223318', max_length=10, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator(message='Cédula ingresada incorrectamente, debe ingresarla nuevamente.', regex='^[V|E]{1}[0]{1}[0-9]{7,9}$')], verbose_name='Cédula')),
